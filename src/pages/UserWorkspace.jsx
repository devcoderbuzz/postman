    ...
    */
    ...
    return (
        <div className="h-screen flex flex-col bg-white dark:bg-[var(--bg-primary)] text-neutral-900 dark:text-[var(--text-primary)] font-sans overflow-hidden">
            ...
            {/* User Info Bar */}
            <div className="px-3 py-1 bg-neutral-100 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 text-xs flex justify-between items-center relative">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative">
                        <button
                            ...
                            className="font-semibold text-neutral-800 dark:text-neutral-200 hover:bg-neutral-200 dark:hover:bg-neutral-800 px-2 py-0.5 rounded transition-colors flex items-center gap-1 focus:outline-none"
                        >
                            {user?.username}
                        </button>
                        {/* Dropdown */}
                        {isSettingsOpen && (
                            <>
                                ...
                                <div className="absolute top-full right-0 mt-1 w-32 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded shadow-lg z-50">
                                    <div className="py-1">
                                        <p className="px-4 py-1 text-[10px] text-neutral-400 uppercase tracking-wider font-semibold">Settings</p>
                                        <button
                                            onClick={() => { setTheme('light'); setIsSettingsOpen(false); }}
                                            className={`w-full text-left px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 flex items-center justify-between ${theme === 'light' ? 'text-red-600 font-medium' : ''}`}
                                        >
                                            Light Mode {theme === 'light' && <span className="text-xs">✓</span>}
                                        </button>
                                        <button
                                            onClick={() => { setTheme('dark'); setIsSettingsOpen(false); }}
                                            className={`w-full text-left px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 flex items-center justify-between ${theme === 'dark' ? 'text-red-600 font-medium' : ''}`}
                                        >
                    ...
                    <button onClick={() => { logout(); navigate('/login'); }} className="text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 hover:underline">Logout</button>
                </div>
            </div>
                    ...
                    <>
                        <div className="flex items-center justify-between px-3 py-2 border-b border-neutral-200 dark:border-[var(--border-color)] bg-neutral-50 dark:bg-[var(--bg-secondary)]">
                            <div className="flex items-center gap-2">
                                {activeEnv && (
                                    <span className="text-xs px-2 py-1 bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 rounded border border-neutral-200 dark:border-neutral-700">
                        ...
                        <div className="flex-1 flex overflow-hidden">
                            ...
                            <div className={`flex-1 flex ${layout === 'vertical' ? 'flex-col' : 'flex-row'} min-w-0 overflow-hidden`}>
                                ...
                                <div
                                    className={`${layout === 'vertical' ? 'h-1 hover:h-1.5 cursor-row-resize w-full' : 'w-1 hover:w-1.5 cursor-col-resize h-full'} bg-neutral-200 dark:bg-[var(--border-color)] hover:bg-red-500 transition-all flex items-center justify-center group z-10`}
            ...
            {showConsole && (
                <div className="h-48 border-t border-neutral-200 dark:border-[var(--border-color)] bg-white dark:bg-[var(--bg-primary)] flex flex-col">
                    <div className="flex items-center justify-between px-3 py-1 border-b border-neutral-200 dark:border-[var(--border-color)] bg-neutral-50 dark:bg-[var(--bg-secondary)]">
