    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold text-neutral-700 dark:text-neutral-300">Environments</h3>
                <button
            ...
            {environments.length === 0 ? (
                <div className="text-center py-8 text-neutral-500 dark:text-neutral-500 text-sm">
                                ...
                                {editingEnv === env.id ? (
                                    ...
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="p-1 text-neutral-500 hover:text-red-500 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded"
                                        >
